...
rtwCAPI_ModelParameters rtModelParameters [ ] = { { 24 , TARGET_STRING (
"v0x" ) , 0 , 0 , 0 } , { 25 , TARGET_STRING ( "v0y" ) , 0 , 0 , 0 } , { 26 ,
TARGET_STRING ( "x0" ) , 0 , 0 , 0 } , { 27 , TARGET_STRING ( "y0" ) , 0 , 0
, 0 } , { 28 , TARGET_STRING ( "Fa" ) , 1 , 0 , 0 } , { 29 , TARGET_STRING (
"Kd" ) , 1 , 0 , 0 } , { 30 , TARGET_STRING ( "Kp" ) , 1 , 0 , 0 } , { 0 , (
NULL ) , 0 , 0 , 0 } } ;
...
[ 0 ] , & rtP . FromWorkspace_Data0_elsudc4efs [ 0 ] , & rtP . v0x , & rtP .
v0y , & rtP . x0 , & rtP . y0 , & rtP . Fa , & rtP . Kd , & rtP . Kp , } ;
...
1 , 1 , 1002 , 1 , 1003 , 1 } ; static const real_T rtcapiStoredFloats [ ] =
...
, { 4013739573U , 2881433035U , 648399044U , 1936786602U } , ( NULL ) , 0 , (
