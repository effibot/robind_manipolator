...
InstanceMap . fullPath , "3abd521f-775a-434a-a74b-6204927e3224" ,
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "1078b89e-8e1b-45d4-9d87-514dc4566720" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "635d135e-bca6-4ed9-a39e-a310757adbb6" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
sdiStartAsyncioQueueCreation ( hDT , & srcInfo , rt_dataMapInfo . mmi .
InstanceMap . fullPath , "0aebd2da-15a2-447e-a2a7-ca99d8174370" ,
sigComplexity , & sigDims , DIMENSIONS_MODE_FIXED , stCont , "" ) ;
...
* ) rtP . FromWorkspace_Data0 ; fromwksInfo -> nDataPoints = 1003 ;
...
; fromwksInfo -> origIsComplex = 0 ; fromwksInfo -> origWidth = 1 ;
fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo -> data = ( void
* ) rtP . FromWorkspace_Data0_erdsjhbktd ; fromwksInfo -> nDataPoints = 1002
...
; fromwksInfo -> origIsComplex = 0 ; fromwksInfo -> origWidth = 1 ;
fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo -> data = ( void
* ) rtP . FromWorkspace_Data0_irypaqsgbf ; fromwksInfo -> nDataPoints = 1002
...
; fromwksInfo -> origIsComplex = 0 ; fromwksInfo -> origWidth = 1 ;
fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo -> data = ( void
* ) rtP . FromWorkspace_Data0_fbwrwi4aj1 ; fromwksInfo -> nDataPoints = 1003
...
; fromwksInfo -> origIsComplex = 0 ; fromwksInfo -> origWidth = 1 ;
fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo -> data = ( void
* ) rtP . FromWorkspace_Data0_elsudc4efs ; fromwksInfo -> nDataPoints = 1002
...
; fromwksInfo -> origIsComplex = 0 ; fromwksInfo -> origWidth = 1 ;
fromwksInfo -> origElSize = sizeof ( real_T ) ; fromwksInfo -> data = ( void
* ) rtP . FromWorkspace_Data0_a2gi03qt2b ; fromwksInfo -> nDataPoints = 1002
...
ekmphufo03 = ( ( ( real_T ) rtP . Kp * rtB . fts1qnwwnm + ( real_T ) rtP . Kd
* rtB . dn3s1knom1 ) * rtP . Gain1_Gain + rtB . ceh1qr02vf ) - ( real_T ) rtP
. Fa ; if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { { int_T currIndex = rtDW .
aeaptdbisy . PrevIndex + 1 ; real_T * pDataValues = ( real_T * ) rtDW .
ejxqv5alzd . DataPtr ; int numPoints ; FWksInfo * fromwksInfo = ( FWksInfo *
) rtDW . ejxqv5alzd . RSimInfoPtr ; numPoints = fromwksInfo -> nDataPoints ;
if ( currIndex < numPoints ) { pDataValues += currIndex ; rtB . bxc5wbeagz =
* pDataValues ; } else { pDataValues += ( numPoints - 1 ) ; rtB . bxc5wbeagz
= * pDataValues ; } rtDW . aeaptdbisy . PrevIndex = currIndex ; } } rtB .
bqqkaib5ws = rtB . of4hv5yd2x - rtB . bxc5wbeagz ; if ( ssIsSampleHit ( rtS ,
1 , 0 ) ) { { int_T currIndex = rtDW . mhiwfrfp0y . PrevIndex + 1 ; real_T *
pDataValues = ( real_T * ) rtDW . d4sbxigd01 . DataPtr ; int numPoints ;
FWksInfo * fromwksInfo = ( FWksInfo * ) rtDW . d4sbxigd01 . RSimInfoPtr ;
numPoints = fromwksInfo -> nDataPoints ; if ( currIndex < numPoints ) {
pDataValues += currIndex ; rtB . erdbg52csk = * pDataValues ; } else { rtB .
erdbg52csk = 0.0 ; } rtDW . mhiwfrfp0y . PrevIndex = currIndex ; } } rtB .
fukvwwoumx = rtB . ayn2l5kx4f - rtB . erdbg52csk ; if ( ssIsSampleHit ( rtS ,
1 , 0 ) ) { { int_T currIndex = rtDW . imsjzof1gf . PrevIndex + 1 ; real_T *
pDataValues = ( real_T * ) rtDW . pc2nyef1qt . DataPtr ; int numPoints ;
FWksInfo * fromwksInfo = ( FWksInfo * ) rtDW . pc2nyef1qt . RSimInfoPtr ;
numPoints = fromwksInfo -> nDataPoints ; if ( currIndex < numPoints ) {
pDataValues += currIndex ; rtB . fo23lqib5q = * pDataValues ; } else { rtB .
fo23lqib5q = 0.0 ; } rtDW . imsjzof1gf . PrevIndex = currIndex ; } } rtB .
mpinfjn4a5 = ( ( ( real_T ) rtP . Kp * rtB . bqqkaib5ws + ( real_T ) rtP . Kd
* rtB . fukvwwoumx ) * rtP . Gain1_Gain_ipqblw4zv4 + rtB . fo23lqib5q ) - (
real_T ) rtP . Fa ; if ( ssIsSampleHit ( rtS , 1 , 0 ) ) { jh2j2gfphf [ 0 ] =
rtB . ekmphufo03 ; jh2j2gfphf [ 1 ] = rtB . mpinfjn4a5 ; { if ( rtDW .
lseu3eofyv . AQHandles && ssGetLogOutput ( rtS ) ) { sdiWriteSignal ( rtDW .
lseu3eofyv . AQHandles , ssGetTaskTime ( rtS , 1 ) , ( char * ) & jh2j2gfphf
[ 0 ] + 0 ) ; } } au5ak3shgm [ 0 ] = rtB . fts1qnwwnm ; au5ak3shgm [ 1 ] =
rtB . bqqkaib5ws ; au5ak3shgm [ 2 ] = rtB . dn3s1knom1 ; au5ak3shgm [ 3 ] =
rtB . fukvwwoumx ; { if ( rtDW . dbtjzghbsv . AQHandles && ssGetLogOutput (
rtS ) ) { sdiWriteSignal ( rtDW . dbtjzghbsv . AQHandles , ssGetTaskTime (
rtS , 1 ) , ( char * ) & au5ak3shgm [ 0 ] + 0 ) ; } } } UNUSED_PARAMETER (
...
rtS ) ) ; _rtXdot -> bvq1aeovgd = rtB . ekmphufo03 ; _rtXdot -> pybolimsew =
rtB . mpinfjn4a5 ; _rtXdot -> p405gjuf1q = rtB . dzhv4gakca ; _rtXdot ->
cuvdeofxzs = rtB . ayn2l5kx4f ; } void MdlProjection ( void ) { } void
MdlTerminate ( void ) { rt_FREE ( rtDW . e1dw0gdlsu . RSimInfoPtr ) ; rt_FREE
( rtDW . loho3tdcc3 . RSimInfoPtr ) ; rt_FREE ( rtDW . b1pf4c5bw1 .
...
ssSetNumBlockIO ( rtS , 16 ) ; ssSetNumBlockParams ( rtS , 6023 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetSampleTime ( rtS , 1 , 0.001 ) ; ssSetOffsetTime ( rtS , 0 , 0.0 ) ;
ssSetOffsetTime ( rtS , 1 , 0.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 4013739573U ) ; ssSetChecksumVal ( rtS , 1 ,
2881433035U ) ; ssSetChecksumVal ( rtS , 2 , 648399044U ) ; ssSetChecksumVal
( rtS , 3 , 1936786602U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
( rtS , 1.0010000000000001 ) ; ssSetStepSize ( rtS , 0.001 ) ;
...
rt_LoggedStateBlockNames [ ] = { "PIDTrajectory/Processo/Integrator" ,
"PIDTrajectory/Processo/Integrator2" , "PIDTrajectory/Processo/Integrator1" ,
"PIDTrajectory/Processo/Integrator3" } ; static const char_T *
...
ssSetChecksumVal ( rtS , 0 , 4013739573U ) ; ssSetChecksumVal ( rtS , 1 ,
2881433035U ) ; ssSetChecksumVal ( rtS , 2 , 648399044U ) ; ssSetChecksumVal
( rtS , 3 , 1936786602U ) ; { static const sysRanDType rtAlwaysEnabled =
