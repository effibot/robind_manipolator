...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . dzhv4gakca
) , 0 , 0 , 16 } , { ( char_T * ) ( & rtDW . a53cvwyjia . LoggedData [ 0 ] )
...
char_T * ) ( & rtP . v0x ) , 0 , 0 , 4 } , { ( char_T * ) ( & rtP . Fa ) , 6
, 0 , 3 } , { ( char_T * ) ( & rtP . FromWorkspace_Data0 [ 0 ] ) , 0 , 0 ,
30064 } } ; static DataTypeTransitionTable rtPTransTable = { 3U ,
rtPTransitions } ;
